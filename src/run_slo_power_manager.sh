...
sudo python slo_power_manager.py -asp /gw/ -ts $2 -st $3 -sl $4 -ap ${saved_data_path}${allocated_power_file}${extension} -mrt ${saved_data_path}${measured_response_time_file}${extension} -trt ${saved_data_path}${tail_response_time_file}${extension} -lf ${saved_data_path}${log_file}${extension1} -ev ${saved_data_path}${error}${extension} -dp ${saved_data_path}${drop}${extension} -er ${saved_data_path}${estimated_request}${extension} -ac ${saved_data_path}${allocated_number_of_core_file}${extension} -rac ${saved_data_path}${reactively_allocated_number_of_core_file}${extension} -pac ${saved_data_path}${proactively_allocated_number_of_core_file}${extension} -sp ${saved_data_path}${measured_server_power_file}${extension} -cu ${saved_data_path}${cpu_utilization_file}${extension} -sr ${saved_data_path}${service_rate}${extension} -cf ${saved_data_path}${cpu_frequency_file}${extension} -bfr ${saved_data_path}${best_fit_req_rate}${extension} -bfc ${saved_data_path}${best_fit_cpu_util}${extension} -tbi ${saved_data_path}${to_be_increased_core}${extension} -tbd ${saved_data_path}${to_be_reduced_core}${extension} -il ${saved_data_path}${info_log}${extension2}
